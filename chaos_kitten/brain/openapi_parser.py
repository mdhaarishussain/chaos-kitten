...
class OpenAPIParser:
    ...
    def parse(self) -> Dict[str, Any]:
        ...
        try:
            ...
            parser = ResolvingParser(
                str(self.spec_path), backend="openapi-spec-validator"
            )
            ...
            if "openapi" in self.spec:
                ...
                raise ValueError(
                    "Unknown specification format. Missing 'openapi' or 'swagger' field."
                )
    ...
    def _extract_endpoints(self, paths: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for path, path_item in paths.items():
            ...
            for method, operation in path_item.items():
                ...
                normalized_params, request_body = self._normalize_parameters(
                    all_params, consumes
                )
    ...
    def get_endpoints(self, tags: Optional[List[str]] = None, methods: Optional[List[str]] = None) -> List[Dict[str, Any]]:
        ...
        if methods:
            ...
            endpoints = [ep for ep in endpoints if ep.get("method") in methods_upper]
